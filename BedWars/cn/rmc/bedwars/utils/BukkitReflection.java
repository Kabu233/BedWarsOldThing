...
/* 211 */       getServerVersion()), CRAFTBUKKIT_BLOCK((String)CRAFTBUKKIT, "block"), CRAFTBUKKIT_CHUNKIO((String)CRAFTBUKKIT, "chunkio"),
/* 212 */     CRAFTBUKKIT_COMMAND((String)CRAFTBUKKIT, "command"), CRAFTBUKKIT_CONVERSATIONS((String)CRAFTBUKKIT, "conversations"),
/* 213 */     CRAFTBUKKIT_ENCHANTMENS((String)CRAFTBUKKIT, "enchantments"),
/* 214 */     CRAFTBUKKIT_ENTITY((String)CRAFTBUKKIT, "entity"), CRAFTBUKKIT_EVENT((String)CRAFTBUKKIT, "event"),
/* 215 */     CRAFTBUKKIT_GENERATOR((String)CRAFTBUKKIT, "generator"),
/* 216 */     CRAFTBUKKIT_HELP((String)CRAFTBUKKIT, "help"),
/* 217 */     CRAFTBUKKIT_INVENTORY((String)CRAFTBUKKIT, "inventory"),
/* 218 */     CRAFTBUKKIT_MAP((String)CRAFTBUKKIT, "map"),
/* 219 */     CRAFTBUKKIT_METADATA((String)CRAFTBUKKIT, "metadata"),
/*     */     
/* 221 */     CRAFTBUKKIT_POTION((String)CRAFTBUKKIT, "potion"),
/*     */     
/* 223 */     CRAFTBUKKIT_PROJECTILES((String)CRAFTBUKKIT, "projectiles"),
/*     */     
/* 225 */     CRAFTBUKKIT_SCHEDULER((String)CRAFTBUKKIT, "scheduler"),
/*     */     
/* 227 */     CRAFTBUKKIT_SCOREBOARD((String)CRAFTBUKKIT, "scoreboard"),
/*     */     
/* 229 */     CRAFTBUKKIT_UPDATER((String)CRAFTBUKKIT, "updater"),
/*     */     
/* 231 */     CRAFTBUKKIT_UTIL((String)CRAFTBUKKIT, "util");
/*     */ 
/*     */     
...
/* 264 */     BYTE((String)byte.class, Byte.class), SHORT((String)short.class, Short.class), INTEGER((String)int.class, Integer.class), LONG((String)long.class, Long.class),
/* 265 */     CHARACTER((String)char.class, Character.class), FLOAT((String)float.class, Float.class),
/* 266 */     DOUBLE((String)double.class, Double.class), BOOLEAN((String)boolean.class, Boolean.class);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
