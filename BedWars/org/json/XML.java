...
/* 356 */             jsonObject.accumulate(string, config.keepStrings ? token : 
/*     */ 
/*     */                 
...
/* 393 */             jsonObject.accumulate(config.cDataTagName, config.keepStrings ? string : 
/* 394 */                 stringToValue(string)); 
/*     */           continue;
/*     */         } 
/* 397 */         if (token == LT)
/*     */         {
...
/*     */       try {
/*     */         
/* 451 */         if (string.indexOf('.') > -1 || string.indexOf('e') > -1 || string
/* 452 */           .indexOf('E') > -1 || "-0".equals(string)) {
...
/* 762 */       (string.length() == 0) ? ("<" + tagName + "/>") : ("<" + tagName + ">" + string + "</" + tagName + ">"));
/*     */   }
/*     */ }


/* Location:              C:\Users\Administrator\Downloads\BedWars-1.0-SNAPSHOT (1).jar!\org\json\XML.class
