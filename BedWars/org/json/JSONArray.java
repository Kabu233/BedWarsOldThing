...
/*      */ 
/*      */     
/*  513 */     StringBuilder sb = new StringBuilder(JSONObject.valueToString(this.myArrayList.get(0)));
/*      */     
...
/* 1245 */     return (index >= 0 && index < length()) ? this.myArrayList
/* 1246 */       .remove(index) : null;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1416 */       if (length == 1) {
/*      */         try {
/* 1418 */           JSONObject.writeValue(writer, this.myArrayList.get(0), indentFactor, indent);
/*      */         }
...
/*      */           try {
/* 1435 */             JSONObject.writeValue(writer, this.myArrayList.get(i), indentFactor, newIndent);
/*      */           }
...
/* 1499 */     return new JSONException("JSONArray[" + idx + "] is not a " + valueType + ".", cause);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1516 */     return new JSONException("JSONArray[" + idx + "] is not a " + valueType + " (" + value + ").", cause);
/*      */   }
/*      */ }


/* Location:              C:\Users\Administrator\Downloads\BedWars-1.0-SNAPSHOT (1).jar!\org\json\JSONArray.class
