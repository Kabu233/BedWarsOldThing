...
/*     */       } 
/* 224 */       if (ja != null) {
/* 225 */         ja.put((token instanceof String) ? (keepStrings ? 
/* 226 */             XML.unescape((String)token) : XML.stringToValue((String)token)) : token);
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/* Location:              C:\Users\Administrator\Downloads\BedWars-1.0-SNAPSHOT (1).jar!\org\json\JSONML.class
