...
/*  487 */     if (object == null) {
/*  488 */       put(key, (value instanceof JSONArray) ? (new JSONArray())
/*  489 */           .put(value) : value);
/*      */     }
...
/*  545 */     if (string.indexOf('.') > 0 && string.indexOf('e') < 0 && string
/*  546 */       .indexOf('E') < 0) {
...
/* 1017 */     if (string.indexOf('.') > 0 && string.indexOf('e') < 0 && string
/* 1018 */       .indexOf('E') < 0) {
...
/*      */     } 
/* 1170 */     if (val instanceof Long || val instanceof Integer || val instanceof Short || val instanceof Byte)
/*      */     {
...
/*      */     } 
/* 1221 */     if (val instanceof Long || val instanceof Integer || val instanceof Short || val instanceof Byte)
/*      */     {
...
/*      */     
/*      */     try {
/* 1609 */       return getAnnotation(c
/* 1610 */           .getSuperclass().getMethod(m.getName(), m.getParameterTypes()), annotationClass);
/*      */     }
...
/*      */     
/*      */     try {
/* 1666 */       int d = getAnnotationDepth(c
/* 1667 */           .getSuperclass().getMethod(m.getName(), m.getParameterTypes()), annotationClass);
/*      */       
/* 1669 */       if (d > 0)
/*      */       {
/* 1671 */         return d + 1;
...
/* 2093 */     return (val.indexOf('.') > -1 || val.indexOf('e') > -1 || val
/* 2094 */       .indexOf('E') > -1 || "-0".equals(val));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 2232 */           throw new JSONException("JSON does not allow non-finite numbers.");
/*      */         }
/*      */       }
/* 2235 */       else if (o instanceof Float && ((
/* 2236 */         (Float)o).isInfinite() || ((Float)o).isNaN())) {
/* 2237 */         throw new JSONException("JSON does not allow non-finite numbers.");
/*      */       } 
/*      */     }
/*      */   }
/*      */ 
...
/* 2368 */         return NULL;
/*      */       }
/* 2370 */       if (object instanceof JSONObject || object instanceof JSONArray || NULL
/* 2371 */         .equals(object) || object instanceof JSONString || object instanceof Byte || object instanceof Character || object instanceof Short || object instanceof Integer || object instanceof Long || object instanceof Boolean || object instanceof Float || object instanceof Double || object instanceof String || object instanceof BigInteger || object instanceof BigDecimal || object instanceof Enum)
/*      */       {
/*      */ 
/*      */ 
/*      */ 
...
/*      */       
/* 2394 */       String objectPackageName = (objectPackage != null) ? objectPackage.getName() : "";
/* 2395 */       if (objectPackageName.startsWith("java.") || objectPackageName
/* 2396 */         .startsWith("javax.") || object
/* 2397 */         .getClass().getClassLoader() == null) {
...
/* 2561 */     Map<String, Object> results = new HashMap<String, Object>();
...
/* 2589 */     return new JSONException("JSONObject[" + 
/* 2590 */         quote(key) + "] is not a " + valueType + ".", cause);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 2606 */     return new JSONException("JSONObject[" + 
/* 2607 */         quote(key) + "] is not a " + valueType + " (" + value + ").", cause);
/*      */   }
/*      */ }


/* Location:              C:\Users\Administrator\Downloads\BedWars-1.0-SNAPSHOT (1).jar!\org\json\JSONObject.class
