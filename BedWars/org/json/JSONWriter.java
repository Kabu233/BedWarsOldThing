...
/* 163 */     if (this.mode != m) {
/* 164 */       throw new JSONException((m == 'a') ? "Misplaced endArray." : "Misplaced endObject.");
/*     */     }
/*     */ 
/*     */     
/* 168 */     pop(m);
...
/*     */     }
/* 277 */     this.top--;
/* 278 */     this.mode = (this.top == 0) ? 'd' : ((this.stack[this.top - 1] == null) ? 'a' : 'k');
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Administrator\Downloads\BedWars-1.0-SNAPSHOT (1).jar!\org\json\JSONWriter.class
