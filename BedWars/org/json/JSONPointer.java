...
/* 192 */     return token.replace("~1", "/").replace("~0", "~").replace("\\\"", "\"").replace("\\\\", "\\");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 274 */     return token.replace("~", "~0").replace("/", "~1").replace("\\", "\\\\").replace("\"", "\\\"");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Administrator\Downloads\BedWars-1.0-SNAPSHOT (1).jar!\org\json\JSONPointer.class
